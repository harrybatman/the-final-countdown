<template lang="pug">
- var cards = [{ title: 'Mountain View', copy: '漂亮的山', button: 'Nothing\'ll happen' }, { title: 'To The Beach', copy: '漂亮的星空和海灘', button: 'Nothing\'ll happen' }, { title: 'Desert Destinations', copy: '星空與沙', button: 'Nothing\'ll happen' }, { title: 'Explore The Galaxy', copy: '拜託不要當我', button: 'Nothing\'ll happen' }]
